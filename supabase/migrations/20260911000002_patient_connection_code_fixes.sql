...
as $$
begin
  return public.get_patient_share_code_for_patient(null);
end;
$$;
...
revoke all on function public.get_patient_share_code_for_patient(uuid) from public;
grant execute on function public.get_patient_share_code_for_patient(uuid) to authenticated;
